  ...
  const data = {
    ...
    routes: [
      ...
      },
      {
        ...
        kind: 'normal',
        predicate:
          'Accepted sample identities describe the latest checked parts in this current playback lifetime. Forward motion may retain their highlight with an explicit earlier-pose label until superseded; seeking clears it. No current-contact or contact-region geometry is inferred.',
        producedArtifacts: ['artifact:live-feedback']
      },
      {

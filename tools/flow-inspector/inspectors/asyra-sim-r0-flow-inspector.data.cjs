    ...
    steps: [
      ...
      },
      {
        ...
        conditions: [
          ...
          'Completed valid observation text edits apply through the existing editing Feature and keep the editor on the acknowledged observation identity. Incomplete input is transient, stale edits reject, and prepared attachments require Apply attachments before source retention and the separate metadata transaction.',
          'Ordinary experiment field edits apply through the existing editing Feature when the edit gesture completes. Incomplete or invalid field text remains transient. Serialize pending field actions against the latest canonical revision without dropping later edits or replacing them with an older acknowledgement. External Undo/Redo restores the canonical projection. Import previews remain noncanonical until Apply.',

    ...
    steps: [
      ...
      },
      {
        ...
        conditions: [
          ...
          'Unchanged App-generated trajectory text starts with known canonical units; new external CSV or first edits of unconfirmed App defaults receive column suggestions with undeclared units. Explicit user unit declarations survive numeric edits of the same source; missing mapped columns retire only affected declarations, and another CSV requires fresh declarations. Strict JSON keeps its own declarations. The current source-read artifact and storage conversion preview are shared through review and draft acceptance; source, mapping, unit, workcell, cancellation or lifetime changes invalidate acceptance and late reads. UI displays bounded owner-produced conversion values and never converts values itself or changes canonical state before the existing save Feature.',

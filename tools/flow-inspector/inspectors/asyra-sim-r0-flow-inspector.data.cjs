    ...
    steps: [
      ...
      },
      {
        ...
        cacheDimensions: [
          ...
          'A transported upper-source handle exists only between consumed fresh static samples of one current node. The first sample has no seed. Inherited, final and ineligible samples, or samples whose next endpoint is inherited, create no handle. No parent-child seed handoff, global registry, arbitrary evidence admission, cross-node/segment/invocation retention or geometry-preparation pose cache is permitted; copied immutable source poses expire with that node.'
        ],
        implementationBoundary: [

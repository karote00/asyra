    ...
    steps: [
      ...
      },
      {
        ...
        conditions: [
          ...
          'Experiment metadata queries share the runtime, canonical revision and candidate invalidation boundary; draft-only edits do not recapture canonical experiments. Hierarchy and scope rows consume their displayed scalar fields; numerical draft edits do not redraw scope rows, and scope callbacks preserve the latest other draft fields. Mount, joint and original-placement controls reuse unchanged complete field values and units, while section callbacks merge into the latest committed body. View reuse never scans or retains source triangles, bypasses canonical reads on revision, or owns editable state.',

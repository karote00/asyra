    ...
    steps: [
      ...
      },
      {
        ...
        conditions: [
          ...
          'Unchanged App-generated trajectory text starts with known canonical units; external or edited CSV only receives column suggestions with undeclared units. Strict JSON keeps its own declarations. The current source-read artifact and storage conversion preview are shared through review and draft acceptance; source, mapping, unit, workcell, cancellation or lifetime changes invalidate acceptance and late reads. UI displays bounded owner-produced conversion values and never converts values itself or changes canonical state before the existing save Feature.',

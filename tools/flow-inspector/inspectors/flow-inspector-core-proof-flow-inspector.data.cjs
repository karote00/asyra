const data = {
  ...
  artifacts: [
    ...
    { id: 'artifact:target-source-assessment', ownerStepId: 'assess-target-source', channel: 'source-bound target assessment', consumerStepIds: ['serve-proof-actions', 'manage-flow-target'] },

...
import { StoryChapter, StoryNavigation } from '@/components/story-navigation'
        ...
        <StoryChapter index={0}>
            ...
            <div className="hero__copy">
              ...
              <p className="hero__lead">
                <span className="reference-line">
                  ...
                  and identity in your hands.
                </span>
                <span className="reference-line">
                  Asyra provides the shared foundation to build on.
                </span>
              </p>
              <p className="hero__category">
                A composable framework for domain-driven software.
              </p>
          ...
          >
            <div className="domains__heading">
              ...
              <p>
                Design tools, research workspaces, BIM systems, studio
                pipelines, field apps, simulations, and whatever your world
                needs next.
              </p>
            </div>
        ...
        <StoryChapter index={1}>
            ...
            <div className="poc-story__inner">
              <div className="poc-story__heading">
                ...
                <div className="poc-story__intro">
                  ...
                  <ul
                    aria-label="Storyboard paths"
                    className="poc-story__legend"
                  >
          ...
          >
            <div className="product-evidence__copy">
              ...
              <p>
                Explore Asyra Design: a working design tool with editable
                layers, app-owned features, and a shared foundation for history
                and persistence.
              </p>
              <ul className="product-evidence__facts">
                <li>7,076 editable vector elements</li>
                <li>App-owned tools and rules</li>
                <li>Shared history and persistence</li>
              </ul>
          ...
          <div className="proof-stack">
            ...
            >
              <div className="proof__copy">
                ...
                <h2 id="grow-title">
                  <span className="reference-line">Room for what</span>
                  <span className="reference-line">comes next.</span>
                </h2>
              </div>
            ...
            >
              <div className="proof__copy">
                ...
                <h2 id="source-title">
                  <span className="reference-line">One model.</span>
                  <span className="reference-line">Many ways to work.</span>
                </h2>
              </div>
        ...
        <StoryChapter index={3}>
          ...
          >
            <header className="feature-evidence__heading">
              ...
              <p>
                Define the behavior once. People and AI use the same Feature,
                with the same product rules.
              </p>
            </header>
            <figure
  ...
  api: {
    setStatus(id: string, status: ReviewState) {
      ...
      return { id, status }
                ...
                <p>
                  In a document-backed Feature, this body calls the generated
                  App common API so Factory owns the transaction and Undo
                  evidence.
                </p>
          ...
          >
            <header>
              ...
              <h2 id="ownership-title">Your product stays yours.</h2>
            </header>
        ...
        <StoryChapter index={4}>
          <section aria-labelledby="readiness-title" className="readiness">
            <header>
              ...
              <p>
                Start with the browser framework and official 2D Preset, or
                compose your own foundation.{' '}

...
`title` and `status` in the inspector. Undo/Redo and explicit Save/Reload
...
Canvas cards are read-only projections of those Item values; selection and
unfinished title input remain transient UI state.

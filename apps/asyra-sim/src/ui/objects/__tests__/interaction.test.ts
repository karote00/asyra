...
import { useViewport } from '../../viewport/use-viewport-projection'
import { ViewportControls } from '../../viewport/viewport-controls'
...
it('does not submit a retained viewport effect after its document lifetime ended', async () => {
  ...
  const runtime = { setFrame } as unknown as SimRuntime

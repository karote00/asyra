...
export const ORIGINAL_PART_METHOD: InstalledMethodDescriptor = {
  ...
  manifest: {
    ...
    reproducibility:
      'Deterministic source-order geometry and median hierarchy; dual-tree descent splits the larger maximum world-bound extent, left on ties. Each temporal leaf tests its first static witness and then attempts a full-interval clearance certificate before further static sampling; unsuccessful attempts retain their work charge. Fixed ray directions with enclosed predicates. No random seed. Chromium arithmetic conformance required.',
    resources:

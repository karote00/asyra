...
| Request | Primary owner and specification |
| --- | --- |
| Dimensions, strips, structural placement | Domain; greenhouse and configuration specs |
| Water cross-section or level | Drain profile; water/crop spec |
...
Read framework contracts when changing their boundaries. Future robot features require a separate product contract before implementation.
